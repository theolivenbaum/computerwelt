...
mod tests {
    ...
    /// Issue #652: path validation must reject malformed paths in every
    /// `FileSystem` entry point, not just `write_file`. Moved here from
    /// `tests/integration/overlay_path_validation_tests.rs` — these
    /// tests construct `OverlayFs` directly and never touch `Bash`, so
    /// they belong with the type they exercise.
    mod path_validation {
        use super::super::*;
        use super::*;
        ...
        #[tokio::test]
        async fn read_file_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn stat_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn exists_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn read_dir_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn remove_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn rename_rejects_bidi_source() {
            let fs = make_overlay();
            let result = fs
        ...
        #[tokio::test]
        async fn rename_rejects_bidi_dest() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn copy_rejects_bidi_source() {
            let fs = make_overlay();
            let result = fs
        ...
        #[tokio::test]
        async fn read_link_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn chmod_rejects_bidi_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn read_file_rejects_deep_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn stat_rejects_deep_path() {
            let fs = make_overlay();
        ...
        #[tokio::test]
        async fn normal_paths_still_work() {
            let fs = make_overlay();
